...
public interface UserService {
    ...
    User register(String firstName, String lastName, String username, String email) throws UserNotFoundException, EmailExistException, UsernameExistException, NumEtudiantDejaPresentException, NumEtudiantNonValideException, InformationIncompletException;
    List<User> getUsers();
